...
function ad_runner({ children, Code }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "app relative" }, children, showOverlay && /* @__PURE__ */ React.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between px-5 py-3 bg-white/60 backdrop-blur-sm border-b border-black/5" }, /* @__PURE__ */ React.createElement("div", { className: "text-sm text-slate-700 font-semibold", onClick: redirectto }, "Ad run by Dwarkesh & team"), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3" }, timesing && /* @__PURE__ */ React.createElement("div", { className: "px-3 py-1 rounded-full bg-amber-100 text-amber-800 text-sm font-medium shadow-sm" }, cundown), cross && /* @__PURE__ */ React.createElement(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ React.createElement("div", { className: "w-full h-[60vh] md:h-[75vh] lg:h-[85vh] xl:h-[88vh] flex items-center justify-center overflow-hidden bg-black" }, /* @__PURE__ */ React.createElement("div", { className: " h-[90%] w-full absolute cursor-pointer bottom-2.5", onClick: redirectto }), /\.(jpe?g|png|gif|webp|avif|svg)$/i.test(adlink) ? /* @__PURE__ */ React.createElement(
        "img",
        {
          src: adlink,
          alt: "Ad",
      ...
      /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between px-6 py-3 bg-white/60 backdrop-blur-sm border-t border-black/5" }, /* @__PURE__ */ React.createElement("div", { className: "text-xs text-slate-500" }, "Sponsored"), /* @__PURE__ */ React.createElement("div", { className: "text-xs text-slate-500" }, "Click anywhere to continue"))
    )
  ));
}
